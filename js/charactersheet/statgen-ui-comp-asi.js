...
export class StatGenUiCompAsi extends BaseComponent {
	...
	render ($wrpAsi) {
		...
		const {ipt: iptCountClasses, wrp: wrpCountClasses} = ComponentUiUtil.getIptInt(this._parent, "common_cntClasses", 0, {min: 0, max: MAX_CUSTOM_FEATS, asMeta: true, decorationLeft: "spacer", decorationRight: "ticker"});
		iptCountClasses.removeClass("ve-text-right").addClass("ve-text-center");
		wrpCountClasses.addClass("w-100p");
